...
function XX59HeadphoneDetailMain() {
        ...
        <div className="container mx-auto px-11 md:px-40 py-8">
          <div className="grid md:grid-cols-2 gap-20 md:gap-32 items-center">
            <div className="bg-gray-100 rounded-lg overflow-hidden">
              <img
                src="/src/public/assets/product-xx59-headphones/desktop/image-product.jpg"
                alt="XX59 Headphones"
            ...
            <div className="text-start md:text-left">
              ...
              <p className="text-lg font-bold mb-5 md:mb-8">$899</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  className="bg-orange-400 hover:bg-orange-300 text-white px-8 py-3 uppercase tracking-widest text-sm font-bold transition-all duration-300 md:w-auto cursor-pointer"
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    handleAddToCart();
...
export default XX59HeadphoneDetailMain;
