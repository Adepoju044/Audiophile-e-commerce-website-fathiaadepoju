      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        <div className="grid grid-rows-2 gap-6 md:gap-8">
          <div className="bg-gray-100 rounded-lg overflow-hidden">
            <img
              src="/src/public/assets/product-xx99-mark-two-headphones/desktop/image-gallery-1.jpg"
              alt="Gallery 1"
          ...
          <div className="bg-gray-100 rounded-lg overflow-hidden">
            <img
              src="/src/public/assets/product-xx99-mark-two-headphones/desktop/image-gallery-2.jpg"
              alt="Gallery 2"
              className="w-full h-64 sm:h-72 md:h-64 lg:h-72 object-cover group-hover:scale-105 transition-transform duration-500"
            />
          </div>
        ...
        <div className="bg-gray-100 rounded-lg overflow-hidden">
          <img
            src="/src/public/assets/product-xx99-mark-two-headphones/desktop/image-gallery-3.jpg"
            alt="Gallery 3"
